...
const smsSdemote = () => { return '*@user 𝐻𝐴 𝑆𝐼𝐷𝑂 𝖣𝖤𝖦𝖱𝖠𝖣𝖠𝖣𝖮 𝖢𝖮𝖬𝖮 𝖠𝖣𝖬𝖨𝖭 𝖣𝖤𝖫 𝖦𝖱𝖴𝖯𝖮!!*'}
const smsSdesc = () => { return '*𝖢𝖮𝖭𝖮𝖹𝖢𝖠𝖭 𝖫𝖠 𝖭𝖴𝖤𝖵𝖠 𝖣𝖤𝖲𝖢𝖱𝖨𝖯𝖢𝖨𝖮́𝖭 𝖣𝖤𝖫 𝖦𝖱𝖴𝖯𝖮:*\n\n@desc'}
...
//_antiprivado 
const smsprivado = () => { return `*NO PUEDE USAR ESTE BOT EN CHAT PRIVADO*\n\n*Unirte al Grupo oficial del bot para poder usar el bot hola soy MakeBot-MD*`}
