...
const smsAvisoRG = () => { return `╰⊱✅⊱ 𝑅𝐸𝑆𝑈𝐿𝑇𝐴𝐷𝑂 ⊱✅⊱╮\n\n` } 
const smsAvisoAG = () => { return `╰⊱⚠️⊱ 𝐴𝐷𝑉𝐸𝑅𝑇𝐸𝑁𝐶𝐼𝐴 ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ 𝐼𝑁𝐹𝑂𝑅𝑀𝐴𝐶𝐼𝑂́𝑁 ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ 𝐸𝑅𝑅𝑂𝑅 ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ 𝐴𝐶𝐶𝐼𝑂́𝑁 𝑀𝐴𝐿 𝑈𝑆𝐴𝐷𝐴 ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ 𝑅𝐸𝑃𝑂𝑅𝑇𝐸 ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ 𝐄́𝐗𝐈𝐓𝐎 ⊱💚⊱╮\n\n` }

const smsRowner = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 SÓ𝐿𝑂 𝐸𝐿 𝑁𝑈́𝑀𝐸𝑅𝑂 𝐷𝐸𝐿 𝐵𝑂𝑇 𝑃𝑈𝐸𝐷𝐸 𝑈𝑆𝐴𝑅!!\`\`\`` }
const smsOwner = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝑀𝐼 𝐶𝑅𝐸𝐴𝐷𝑂𝑅(𝐴) 𝐿𝑂 𝑃𝑈𝐸𝐷𝐸 𝑈𝑆𝐴𝑅!!\`\`\`` }
const smsMods = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝑀𝑂𝐷𝐸𝑅𝐴𝐷𝑂𝑅𝐸𝑆 𝑌 𝑀𝐼 𝐶𝑅𝐸𝐴𝐷𝑂𝑅(𝐴) 𝐿𝑂 𝑃𝑈𝐸𝐷𝐸𝑁 𝑈𝑆𝐴𝑅!!\`\`\`\`` }
const smsPremium = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝐸𝑆𝑇𝐴 𝐷𝐼𝑆𝑃𝑂𝑁𝐼𝐵𝐿𝐸 𝑃𝐴𝑅𝐴 𝑈𝑆𝑈𝐴𝑅𝐼𝑂𝑆 𝑃𝑅𝐸𝑀𝐼𝑈𝑀 𝑌 𝑀𝐼 𝐶𝑅𝐸𝐴𝐷𝑂𝑅(𝐴)!! 𝑃𝐴𝑅𝐴 𝑆𝐸𝑅 𝑃𝑅𝐸𝑀𝐼𝑈𝑀 𝐶𝑂𝑀𝑃𝑅𝐸 𝑈𝑁 𝑃𝐴𝑆𝐸 𝑈𝑆𝐴𝑁𝐷𝑂 #pass premium\`\`\`` }
const smsGroup = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝑆𝐸 𝑃𝑈𝐸𝐷𝐸 𝑈𝑇𝐼𝐿𝐼𝑍𝐴𝑅 𝐸𝑁 𝐺𝑅𝑈𝑃𝑂𝑆!!\`\`\`` }
const smsPrivate = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑆𝑂́𝐿𝑂 𝑆𝐸 𝑃𝑈𝐸𝐷𝐸 𝑈𝑇𝐼𝐿𝐼𝑍𝐴𝑅 𝐴𝐿 𝑃𝑅𝐼𝑉𝐴𝐷𝑂!!\`\`\`` }
const smsAdmin = () => { return `\`\`\`¡¡𝙴𝚂𝚃𝙴 𝙲𝙾𝙼𝙰𝙽𝙳𝙻 𝙴𝚂 𝚂𝙾𝙻𝙾 𝙿𝙰𝚁𝙰 𝙰𝙳𝙼𝙸𝙽𝚂😹🫵🏻!!\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`¡¡𝑁𝐸𝐶𝐸𝑆𝐼𝑇𝑂 𝑆𝐸𝑅 𝐴𝐷𝑀𝐼𝑁 𝑃𝐴𝑅𝐴 𝑄𝑈𝐸 𝑃𝑈𝐸𝐷𝐴𝑆 𝑈𝑆𝐴𝑅 𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂!!\`\`\`` }
const smsUnreg = () => { return `\`\`\`¡¡𝑁𝐸𝐶𝐸𝑆𝐼𝑇𝐴𝑆 𝐸𝑆𝑇𝐴𝑅 𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝐷𝑂(𝐴) 𝑃𝐴𝑅𝐴 𝑈𝑆𝐴𝑅 𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂, 𝐸𝑆𝐶𝑅𝐼𝐵𝐸 #verificar 𝑃𝐴𝑅𝐴 𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝑅𝑇𝐸!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`¡¡𝐸𝑆𝑇𝐸 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝐸𝑆𝑇𝐴́ 𝑅𝐸𝑆𝑇𝑅𝐼𝑁𝐺𝐼𝐷𝑂 𝑃𝑂𝑅 𝑀𝐼 𝐶𝑅𝐸𝐴𝐷𝑂𝑅(A)!!\`\`\`` }

//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊👾 𝑩𝑰𝑬𝑵𝑽𝑬𝑵𝑰𝑫𝑶(𝑨)!!*\n┊💖 @user\n┊📄 *𝐿𝐸𝐴 𝐿𝐴 𝐷𝐸𝑆𝐶𝑅𝐼𝑃𝐶𝐼𝑂́𝑁 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ *@user*\n┊ *𝑁𝑂 𝐹𝑈𝐸 𝐷𝐼𝐺𝑁𝑂(𝐴) 𝐷𝐸 𝐸𝑆𝑇𝐴𝑅 𝐴𝑄𝑈𝐼́!!* 🌟\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user 𝐻𝐴 𝑆𝐼𝐷𝑂 𝐴𝑆𝐶𝐸𝑁𝐷𝐼𝐷𝑂 𝐶𝑂𝑀𝑂 𝐴𝐷𝑀𝐼𝑁 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*'}
const smsSdemote = () => { return '*@user 𝐻𝐴 𝑆𝐼𝐷𝑂 𝐷𝐸𝐺𝑅𝐴𝐷𝐴 𝐶𝑂𝑀𝑂 𝐴𝐷𝑀𝐼𝑁 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂!!*'}
const smsSdesc = () => { return '*𝐶𝑂𝑁𝑂𝑍𝐶𝐴𝑁 𝐿𝐴 𝑁𝑈𝐸𝑉𝐴 𝐷𝐸𝑆𝐶𝑅𝐼𝑃𝐶𝐼𝑂́𝑁 𝐷𝐸𝐿 𝐺𝑅𝑈𝑃𝑂:*\n\n@desc'}
const smsSsubject = () => { return '*𝖲𝖤 𝖧𝖠 𝖠𝖢𝖳𝖴𝖠𝖫𝖨𝖹𝖠𝖣𝖮 𝖤𝖫 𝖭𝖮𝖬𝖡𝖱𝖤 𝖣𝖤𝖫 𝖦𝖱𝖴𝖯𝖮!!*\n@subject'}
...
//_antiprivado 
const smsprivado = () => { return `*𝑁𝑂 𝑃𝑈𝐸𝐷𝐸𝑆 𝑈𝑆𝐴𝑅 𝐸𝑆𝑇𝐸 𝐵𝑂𝑇 𝐸𝑁 𝐶𝐻𝐴𝑇 𝑃𝑅𝐼𝑉𝐴𝐷𝑂*\n\n*𝑈𝑁𝐼𝑅𝑇𝐸 𝐴𝐿 𝐺𝑅𝑈𝑃𝑂 𝑂𝐹𝐼𝐶𝐼𝐴𝐿 𝐷𝐸𝐿 𝐵𝑂𝑇 𝑃𝐴𝑅𝐴 𝑃𝑂𝐷𝐸𝑅 𝑈𝑆𝐴𝑅 𝐸𝐿 𝐵𝑂𝑇*`}
...
//info-gruposofc.js
const smsGrupoOfc1 = () => { return '*◜🌺 𝐺𝑅𝑈𝑃𝑂𝑆 𝑂𝐹𝐼𝐶𝐼𝐴𝐿𝐸𝑆 🌺◞*'}
const smsGrupoOfc2 = () => { return '*◜🌸 𝐶𝑂𝐿𝐴𝐵𝑂𝑅𝐴𝐶𝑂́𝑁 🌸◞*'}

//info-grupos-lista.js
const smsLisA = () => { return '_*𝐸𝑆𝑇𝐴́ 𝐸𝑁 𝐸𝑆𝑇𝑂𝑆 𝐺𝑅𝑈𝑃𝑂𝑆:*_'}
...
const smsEstado1 = () => { return '𝐸𝑆𝑇𝐴𝐷𝑂'}
const smsEstado2 = () => { return '𝑉𝐸𝑅𝑆𝐼𝑂́𝑁'}
const smsEstado3 = () => { return '𝑈𝑆𝑈𝐴𝑅𝐼𝑂𝑆/𝐴𝑆'}
const smsEstado4 = () => { return '𝑅𝐸𝐺𝐼𝑆𝑇𝑅𝐴𝐷𝑂𝑆/𝐴𝑆'}
const smsEstado5 = () => { return 'C𝐻𝐴𝑇/s 𝑃𝑅𝑂𝐻𝐼𝐵𝐼𝐷𝑂/𝑆'}
const smsEstado6 = () => { return '𝑈𝑆𝑈𝐴𝑅𝐼𝑂𝑆/𝐴𝑆 𝑃𝑅𝑂𝐻𝐼𝐵𝐼𝐷𝑂𝑆/𝐴𝑆'}
const smsEstado7 = () => { return '𝐴𝐶𝑇𝐼𝑉𝐴 𝐷𝑈𝑅𝐴𝑁𝑇𝐸'}
...
const smsMalused2 = () => { return `${lenguajeGB['smsAvisoMG']()} *𝐷𝐸𝐵𝐸 DE 𝑈𝑆𝐴𝑅 𝐸𝐿 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝐶𝑂𝑀𝑂 𝐸𝑁 𝐸𝑆𝑇𝐸 𝐸𝐽𝐸𝑀𝑃𝐿𝑂:*\n`}
const smsMalused3 = () => { return `${lenguajeGB['smsAvisoMG']()} *𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐸 𝐴 𝑈𝑁 𝑀𝐸𝑁𝑆𝐴𝐽𝐸 𝐶𝑂𝑁 𝐸𝐿 𝐶𝑂𝑀𝐴𝑁𝐷𝑂 𝑂 𝑈𝑆𝐸 𝐸𝑆𝑇𝐸 𝐸𝐽𝐸𝑀𝑃𝐿𝑂:*\n`}
...
//descargas.js
const smsYTV2 = () => { return '𝐷𝐸𝑆𝐶𝐴𝑅𝐺𝐴𝑁𝐷𝑂 𝐷𝑂𝐶𝑈𝑀𝐸𝑁𝑇𝑂 𝐷𝐸 𝑉𝐼𝐷𝐸𝑂... 𝐸𝑆𝑃𝐸𝑅𝐸 𝑈𝑁 𝑀𝑂𝑀𝐸𝑁𝑇𝑂'}

//descargas.js
const smsTiktok = () => { return '𝑃𝑅𝑂𝑁𝑇𝑂 𝑇𝐸𝑁𝐷𝑅𝐴́ 𝐸𝐿 VÍ𝐷𝐸𝑂 𝐷𝐸 𝑇𝐼𝐾𝑇𝑂𝐾'}

//descargas.js
const smsGit = () => { return '*𝐸𝑁𝑉𝐼𝐴𝑁𝐷𝑂 𝐴𝑅𝐶𝐻𝐼𝑉𝑂𝑆, 𝑈𝑁 𝑀𝑂𝑀𝐸𝑁𝑇𝑂 🚀*\n*SI NO LLEGA EL ARCHIVOS ES DEBIDO A QUE EL REPOSITORIO ES PESADO*'}

//_antiviewonce.js
const smsAntiView1 = () => { return `\n🪻 \`\`\`PROHIBIDO OCULTA𝑅 PROHIBIDO\`\`\` 🪻`} 
...
//convertidores.js
const smsToimg = () => { return lenguajeGB.smsAvisoMG() + '*𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐴 𝐴 𝑈𝑁 𝑆𝑇𝐼𝐶𝐾𝐸𝑅 𝑃𝐴𝑅𝐴 𝐶𝑂𝑁𝑉𝐸𝑅𝑇𝐼𝑅 𝐴 𝐼𝑀𝐴𝐺𝐸𝑁*'} 

//convertidores.js
const smsConURL = () => { return lenguajeGB.smsAvisoMG() + '*𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐴 𝐴 𝑈𝑁𝐴 𝐼𝑀𝐴𝐺𝐸𝑁 𝑃𝐴𝑅𝐴 𝐶𝑂𝑁𝑉𝐸𝑅𝑇𝐼𝑅 𝐴 𝐸𝑁𝐿𝐴𝐶𝐸*'} 
...
//sticker-sticker.js
const smsSticker1 = (usedPrefix, command) => { return `*𝑅𝐸𝑆𝑃𝑂𝑁𝐷𝐸𝑅 𝐴 𝑈𝑁 𝑉𝐼́𝐷𝐸𝑂, 𝐼𝑀𝐴𝐺𝐸𝑁, 𝑂 𝐸𝑆𝐶𝑅𝐼𝐵𝐴 ${usedPrefix + command} 𝐽𝑈𝑁𝑇𝑂 𝐴 𝑈𝑁 𝐸𝑁𝐿𝐴𝐶𝐸 𝑄𝑈𝐸 𝑇𝐸𝑅𝑀𝐼𝑁𝐸 𝐸𝑁 .jpg .jpeg .gif .png*`}
...
//_allantilink.js 
const smsTextoYT = () => { return '🙀 𝑆𝑈𝑃𝐸𝑅 𝑀𝐴𝐾𝐸𝐵𝑂𝑇-𝑀𝐷 - 𝑊ℎ𝑎𝑡𝑠𝐴𝑝𝑝 '} 
