...
try{
let estado = `*╭𝄗𝄗𖣘 --${lenguajeGB.smsEstado1()}-- 𖣘𝄗𝄗⬣*
...
correo = official[0][0] == String(contact[0]) ? 'wilsmac68@gmail.com' : official[1][0] == String(contact[0]) ? 'wilsmac68@gmail.com' : official[2][0] == String(contact[0]) ? 'wilsmac68@gmail.com' : mail === '' ? lenguajeGB.smsContacto6() : mail
